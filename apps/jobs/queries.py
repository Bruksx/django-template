...
def add_job_post_annotations(queryset: QuerySet[JobPost], talent: Talent) -> QuerySet[JobPost]:
    ...
    queryset = queryset.annotate(
        ...
        methodologies_count=Count("job__skills", filter=Q(job__skills__category_id=methodologies_id)),
        methodologies_intercept_count=Count("job__skills", filter=Q(
            job__skills__category_id=methodologies_id, job__skills__in=talent_methodology_skills
        )),

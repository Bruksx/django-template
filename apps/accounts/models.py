...
from django.db.models import Q, Count, F, Value, Avg, IntegerField, Exists, OuterRef, When, Case
...
class User(AbstractUser, BaseModel):
    ...
    gender = models.CharField(max_length=100, choices=GenderType.choices(), blank=True, null=True)
...
class TalentFilter(BaseModel):
    ...
    roles = models.ManyToManyField("accounts.Role", blank=True, related_name="roles_talent_filter")
    industries = models.ManyToManyField("accounts.Industry", blank=True, related_name="industries_talent_filter")
    locations = models.JSONField(default=list)
    languages = models.ManyToManyField("core.Language")
    educational_levels = models.ManyToManyField('accounts.EducationLevel', blank=True, related_name="educationlevel_talent_filter")
